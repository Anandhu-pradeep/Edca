...
import { Menu, X, ChevronRight, Globe, Database, Cpu, Server, Cloud, Shield, Code, Smartphone } from 'lucide-react'
                            ...
                            <div className="relative py-6 md:w-[calc(100%-11rem)]">
                                <InfiniteSlider
                                    ...
                                    <div className="flex items-center gap-2 text-muted-foreground opacity-70">
                                        ...
                                        <span className="font-bold text-lg">GlobalNet</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-muted-foreground opacity-70">
                                        <Database className="w-8 h-8" />
                                        <span className="font-bold text-lg">DataCore</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-muted-foreground opacity-70">
                                        <Cpu className="w-8 h-8" />
                                        <span className="font-bold text-lg">Compute</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-muted-foreground opacity-70">
                                        <Server className="w-8 h-8" />
                                        <span className="font-bold text-lg">ServerSys</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-muted-foreground opacity-70">
                                    ...
                                    <div className="flex items-center gap-2 text-muted-foreground opacity-70">
                                        ...
                                        <span className="font-bold text-lg">SecurOS</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-muted-foreground opacity-70">
                    ...
                    <motion.div
                        ...
                        <div className="flex w-full items-center justify-between gap-12 lg:w-auto">
                            ...
                            <button
                                ...
                                <Menu className="group-data-[state=active]:rotate-180 group-data-[state=active]:scale-0 group-data-[state=active]:opacity-0 m-auto size-6 duration-200 text-primary" />
                                <X className="group-data-[state=active]:rotate-0 group-data-[state=active]:scale-100 group-data-[state=active]:opacity-100 absolute inset-0 m-auto size-6 -rotate-180 scale-0 opacity-0 duration-200 text-primary" />
                            </button>
                                ...
                                <ul className="flex gap-8 text-sm">
                                    {menuItems.map((item, index) => (
                                        <li key={index}>
                                            <Link
                                                href={item.href}
                                                className="text-muted-foreground hover:text-accent-foreground block duration-150 text-secondary-text hover:text-primary transition-colors">
                                                <span>{item.name}</span>
                                            </Link>
                                        </li>
                                    ))}
